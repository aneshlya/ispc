...
allowed-tools: Bash(gh run:*), Bash(gh api:*), Bash(git log:*), Read, Edit, Grep, Glob, Write, Task, WebFetch
---
...
2. Check recent ISPC commits (last 24 hours) for potential regressions
