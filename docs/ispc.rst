...
============================= ============ ==============
ISPC target/arch              ARM arch        ARM ISA
----------------------------- ------------ --------------
``neon-i8x16``/``arm``        ARMv7        ARM
``neon-i8x16``/``aarch64``    N/A          N/A
``neon-i16x8``/``arm``        ARMv7        ARM
``neon-i16x8``/``aarch64``    N/A          N/A
``neon-i32x4``/``arm``        ARMv8-A      AARCH32
``neon-i32x8``/``arm``        ARMv8-A      AARCH32
``neon-i32x4``/``aarch64``    ARMv8-A      AARCH64
``neon-i32x8``/``aarch64``    ARMv8-A      AARCH64
============================= ============ ==============
