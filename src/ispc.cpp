...
Target::Target(Arch arch, const char *cpu, ISPCTarget ispc_target, PICLevel picLevel, MCModel code_model,
    ...
    // Set Fp64Support to true by default (was the only capability defaulted to true)
    ...
    case ISPCTarget::avx2_i8x32:
        ...
        setCapability(TargetCapability::Rand);
    ...
    case ISPCTarget::avx512icl_x4:
        ...
        setCapability(TargetCapability::HalfConverts);
        setCapability(TargetCapability::Rand);
        setCapability(TargetCapability::Transcendentals, false);
        setCapability(TargetCapability::Trigonometry, false);
        setCapability(TargetCapability::Rsqrtd);
        setCapability(TargetCapability::Rcpd);
        setCapability(TargetCapability::IntelVNNI, (m_ispc_target == ISPCTarget::avx512icl_x4));
        setCapability(TargetCapability::ConflictDetection);
    ...
    case ISPCTarget::avx512icl_x64:
        ...
        setCapability(TargetCapability::Transcendentals, false);
        setCapability(TargetCapability::Trigonometry, false);
        setCapability(TargetCapability::Rsqrtd, false);
        setCapability(TargetCapability::Rcpd, false);
    ...
    case ISPCTarget::avx512spr_x4:
        ...
        this->m_hasVecPrefetch = false;
        setCapability(TargetCapability::HalfConverts);
        setCapability(TargetCapability::HalfFullSupport);
        setCapability(TargetCapability::Rand);
        setCapability(TargetCapability::Transcendentals, false);
        setCapability(TargetCapability::Trigonometry, false);
        setCapability(TargetCapability::Rsqrtd);
    ...
    case ISPCTarget::avx10_2_x4:
        ...
        setCapability(TargetCapability::Fp16Support);
        setCapability(TargetCapability::IntelVNNI);
        setCapability(TargetCapability::IntelVNNI_Int8);
        setCapability(TargetCapability::IntelVNNI_Int16);
        setCapability(TargetCapability::ConflictDetection);
        setCapability(TargetCapability::Rsqrtd);
        setCapability(TargetCapability::Rcpd);
        CPUfromISA = CPU_DMR;
    ...
    case ISPCTarget::rvv_x4:
        ...
        this->m_maskingIsFree = false;
        this->m_maskBitCount = 1;
        setCapability(TargetCapability::HalfConverts, false);
        setCapability(TargetCapability::HalfFullSupport, false);
        setCapability(TargetCapability::Transcendentals, false);
        setCapability(TargetCapability::Trigonometry, false);
        setCapability(TargetCapability::Rcpd, false);
        setCapability(TargetCapability::Rsqrtd, false);
    ...
    case ISPCTarget::gen9_x8:
        ...
        setCapability(TargetCapability::HalfConverts);
        setCapability(TargetCapability::HalfFullSupport);
        setCapability(TargetCapability::SaturatingArithmetic);
        setCapability(TargetCapability::Transcendentals);
        setCapability(TargetCapability::Trigonometry);
        CPUfromISA = GPU_SKL;
        break;
    ...
    case ISPCTarget::xehpg_x8:
        ...
        setCapability(TargetCapability::Transcendentals);
        setCapability(TargetCapability::Trigonometry);
        setCapability(TargetCapability::XePrefetch);
